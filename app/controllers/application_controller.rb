class ApplicationController < ActionController::Base
  ...
  def update_allowed_parameters
    devise_parameter_sanitizer.permit(:sign_up) { |u| u.permit(:email, :full_name, :password, :password_confirmation) }
    devise_parameter_sanitizer.permit(:account_update) do |u|
      u.permit(:email, :full_name, :password, :password_confirmation, :current_password)
    end
  end
end
