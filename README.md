...
**Budget Tracker** is a simple ruby on rails application developed to help manage Spending based on category
...
```
git clone https://github.com/byiringiroscar/Budget-managmenent-with-Ruby-on-rails
...
```
cd Budget-managmenent-with-Ruby-on-rails
```
...
Feel free to check the [issues page](https://github.com/byiringiroscar/wikipedia-project-with-rails/issues).
